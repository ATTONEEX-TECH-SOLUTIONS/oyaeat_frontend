...
export default function CustomerLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-[#2d5f4f] hidden sm:block">oyaeat</span>
            </Link>
          </div>
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 py-6 md:py-8 space-y-12">
        ...
        <section className="relative rounded-3xl overflow-hidden bg-gradient-to-br from-[#2d5f4f] to-[#1a382e] text-white shadow-2xl">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between p-8 md:p-14 gap-8">
            <div className="flex-1 space-y-5 max-w-xl">
              <span className="inline-block px-4 py-1.5 bg-white/20 backdrop-blur-md rounded-full text-xs font-bold uppercase tracking-widest shadow-sm">
                Special Offer
              </span>
              ...
              <div className="pt-4">
                <Button className="rounded-full bg-white text-[#2d5f4f] hover:bg-gray-100 px-8 py-6 text-lg font-bold shadow-xl hover:scale-105 transition-all duration-300">
            ...
            <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 flex-shrink-0 mt-6 md:mt-0 items-center justify-center flex">
               ...
               />
               <div className="absolute top-4 -right-4 bg-white text-gray-900 px-4 py-2 rounded-2xl shadow-xl font-bold flex items-center gap-2 rotate-12 animate-bounce flex-col text-sm border border-gray-100">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
              {restaurants.map((restaurant) => (
                <div 
                  key={restaurant.id} 
                  className="bg-white rounded-[2rem] overflow-hidden shadow-sm border border-gray-100 hover:shadow-2xl hover:border-[#2d5f4f]/20 transition-all duration-300 cursor-pointer group flex flex-col h-full ring-1 ring-black/5"
                >
                  <div className="relative h-56 overflow-hidden">
                    ...
                    <button className="absolute top-4 right-4 p-2.5 bg-white/90 backdrop-blur-md rounded-full shadow-sm hover:bg-red-50 hover:text-red-500 transition-colors duration-200 z-20 group/btn">
                      <Heart className="w-5 h-5 text-gray-400 group-hover/btn:fill-red-500 group-hover/btn:text-red-500 transition-colors" />
                    </button>
                    <div className="absolute bottom-4 left-4 px-3 py-1.5 bg-white/95 backdrop-blur-md rounded-xl shadow-lg text-xs font-bold text-gray-900 z-20 flex items-center gap-1.5">
