...
export default function VendorSupportPage() {
  return (
    <div className="w-full flex flex-col h-[calc(100vh-60px)] pb-6">
      <div className="mb-6">
      ...
      <div className="flex-1 rounded-2xl border shadow-sm overflow-hidden bg-white" style={{ borderColor: '#c8e6c9' }}>
